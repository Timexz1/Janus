...
const OCR_PROMPT = [
  ...
  '"parsed": {',
  '"broker": "Webull|Dime|null", "brokerId": "webull|dime|null",',
  ...
  "}}",
  "brokerId ต้องเป็น webull หรือ dime เท่านั้น ห้ามใส่เลขบัญชี (เช่น CTH4675306) เด็ดขาด — ให้เลือกจากชื่อโบรกเกอร์.",
